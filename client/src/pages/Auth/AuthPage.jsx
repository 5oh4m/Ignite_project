...
const AuthPage = () => {
    ...
    const { login, register, user, loading } = useAuth(); // Loading from context check
    ...
    const handleSocialLogin = () => {
        toast.error('Social login is not implemented yet. Please use Email/Password.');
    };
            ...
            <div className="max-w-md w-full space-y-8 glass p-8 rounded-3xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button type="button" onClick={handleSocialLogin} className="flex items-center justify-center px-4 py-2 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors bg-white">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <AnimatePresence>
                            {!isLogin && (
                                <motion.div
                                    ...
                                    className="overflow-hidden"
                                >
                                    <label className="block text-sm font-medium text-slate-700 mb-1 opacity-0">Confirm Password</label>
                        ...
                        <div>
                            <button
                                ...
                                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white bg-calm-blue hover:bg-calm-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-calm-blue transition-all shadow-lg hover:shadow-calm-blue/30 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
