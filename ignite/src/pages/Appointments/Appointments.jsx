...
const Appointments = () => {
    ...
    const filteredAppointments = appointments.filter(app =>
        activeTab === 'upcoming' ? app.status === 'Upcoming' : app.status === 'Completed'
    );
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex justify-between items-center mb-8">
                ...
                <button className="flex items-center gap-2 bg-calm-blue text-white px-4 py-2.5 rounded-xl font-medium shadow-lg hover:bg-calm-blue-dark transition-all hover:-translate-y-0.5">
